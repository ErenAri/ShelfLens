...
DEFAULT_MIN_RECOGNITION_CONFIDENCE = "0.96" if DETECTOR_MODEL_PATH else "0.60"
MIN_RECOGNITION_CONFIDENCE = float(
    os.getenv("SHELFLENS_MIN_RECOGNITION_CONFIDENCE", DEFAULT_MIN_RECOGNITION_CONFIDENCE)
)
